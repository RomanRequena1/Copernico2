...
object Timescaledb {
  ...
  def updateData(input: String, topico: String, ev_id: String, paso: String, time_paso: String, conn: Connection,  actorRef: ActorRef): Unit = {
  ...
  def updateData2(input: String, topico: String, ev_id: String, paso: String, time_paso: String, conn: Connection , actorRef: ActorRef): Unit = {
