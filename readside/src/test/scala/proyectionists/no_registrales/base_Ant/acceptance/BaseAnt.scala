package proyectionists.no_registrales.base_Ant.acceptance
...
import proyectionists.no_registrales.base_Ant.BaseAntSpec
import proyectionists.no_registrales.testkit.{MessageTestkitUtils, MonitoringAndMessageProducerMock}

object BaseAnt {
  def getContext(system: ActorSystem): BaseAntSpec.TestContext = {
