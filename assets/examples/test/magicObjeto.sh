...
do
    ...
    kafkacat -b 0.0.0.0:9092 \
                ...
                -P <<EOF
{"EV_ID": "$y$m$d$h$mi$s$n$resto","SOJ_SUJ_IDENTIFICADOR":"22-667147641-$we","SOJ_TIPO_OBJETO":"A","SOJ_IDENTIFICADOR":"DIOS8","SOJ_CAT_SOJ_ID":"TRI","SOJ_DESCRIPCION":"Des","SOJ_ESTADO":null,"SOJ_ID_EXTERNO":"436786342579","SOJ_CANAL_ORIGEN":"PSRM","SOJ_SUBTIPO":"AUTOMOTOR - Dueño Tipo de Vehículo 10","SOJ_TITULARIDAD":"CONDOMINIO","SOJ_OTROS_ATRIBUTOS":{"SOJ_DETALLES":[{"RESPONSABLE_OTROS_ATRIBUTOS":"S","PORCENTAJE_OTROS_ATRIBUTOS":"100","SOJ_OWNER":"Kripke, Barry"}]}}
