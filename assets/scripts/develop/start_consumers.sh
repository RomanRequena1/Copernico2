...
# curl -X POST http://0.0.0.0:8081/kafka/start/DGR-COP-ETAPAS-PROCESO
...
# curl -X POST http://0.0.0.0:8081/kafka/start/DGR-COP-PARAMPLAN

# curl -X POST http://0.0.0.0:8081/kafka/start/DGR-COP-PARAMRECARGO
