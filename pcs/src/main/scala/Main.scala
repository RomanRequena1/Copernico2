...
import consumers.registral.objeto_juicio.infrastructure.main.ObjetoJuicioMicroservice
...
object Main extends App {
  ...
  def microservices(microserviceProvisioning: KafkaConsumerMicroserviceRequirements): Seq[KafkaConsumerMicroservice] = {
    ...
    Seq(
      ...
      new consumers.registral.componente_i.infrastructure.main.ComponenteIMicroservice,
