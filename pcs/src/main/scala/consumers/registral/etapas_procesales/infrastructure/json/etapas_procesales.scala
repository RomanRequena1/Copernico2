...
import consumers.registral.etapas_procesales.application.entities.EtapasProcesalesExternalDto.{DetalleEtapasProcesales, EtapasProcesalesAnt, EtapasProcesalesTri}
...
package object json {
  ...
  implicit val EtapasProcesalesDtoDecoder: Decoder[EtapasProcesalesExternalDto] = deriveDecoder
  implicit val EtapasProcesalesDtoEncoder: Encoder[EtapasProcesalesExternalDto] = deriveEncoder
  ...
  implicit val DetalleEtapasProcesalesTriDecoder: Decoder[DetalleEtapasProcesales] = deriveDecoder
  implicit val DetalleEtapasProcesalesTriEncoder: Encoder[DetalleEtapasProcesales] = deriveEncoder
